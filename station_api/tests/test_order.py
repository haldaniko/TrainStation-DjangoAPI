...
class JourneyTests(APITestCase):
    def setUp(self):
        ...
        self.departure_time = timezone.make_aware(
            datetime.strptime(departure_datetime_str, "%Y-%m-%d %H:%M:%S")
        )
        self.arrival_time = timezone.make_aware(
            datetime.strptime(arrival_datetime_str, "%Y-%m-%d %H:%M:%S")
        )
    ...
    def test_create_journey(self):
        ...
        self.assertEqual(
            response.data["departure_time"].replace("Z", "+00:00"),
            payload["departure_time"],
        )
        self.assertEqual(
            response.data["arrival_time"].replace("Z", "+00:00"),
    ...
    def test_list_journey(self):
        ...
        self.assertEqual(
            journey_data["departure_time"].replace("Z", "+00:00"),
            self.departure_time.isoformat(),
        )
        self.assertEqual(
            journey_data["arrival_time"].replace("Z", "+00:00"),
